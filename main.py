...
print(a.summarize(text))
print("---")
print(a.paraphrase(text))
print("---")
print(a.chat(text + "Что такое дисперсия?"))
print("---")
print(a.chat("А что такое энергия?"))
print("---")
print(a.chat("Кто ты?"))
print("---")
print(a.chat("Про что мы изначально говорили?"))